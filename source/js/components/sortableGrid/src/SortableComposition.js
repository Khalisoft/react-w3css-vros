...
return class Sortable extends React.Component {
    ...
    sortEnd = (e) => {
      ...
      const {updateListOrder, items, galleryType}= this.props;
      console.log(updateListOrder, items, galleryType);
      this.props.updateState({
        draggingIndex: null
      });

      updateListOrder(items, galleryType);
    }
    ...
    render() {
      ...
      return (
        <Component
          className={`grid-item ${this.isDragging() ? draggingClassName : ""}`}
          draggable={true}
